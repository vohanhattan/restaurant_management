...
namespace Management_Restaurant.GUI.User
{
    ...
    public partial class frm_Order : Form
    {
        ...
        public frm_Order(Table table, Area area)
        {
            InitializeComponent();
            this.Text = Utilities.UtilsForm.GetFormTitle(this.Text);
        ...
        private void flowLayoutPanelRight_Paint(object sender, PaintEventArgs e)
        {

        }

        private void flowLayoutPanelRight_Paint_1(object sender, PaintEventArgs e)
        {
        ...
        {
            DialogResult dr = new frm_AddVAT(this.order).ShowDialog();
        ...
        {
            frm_BoSung addExtraDialog = new frm_BoSung(order);
        ...
        {
            frm_AddGiamGia addDiscountDialog = new frm_AddGiamGia(order);
        ...
        {
            //frm_ChangeTable changeTable = new frm_ChangeTable(this.order, this.Tables);
        ...
        private void btnOrder_Click_1(object sender, EventArgs e)
        {
            ...
            {
                MessageBox.Show("Hãy thêm món ăn");
                //return;
               // this.Tables[0].Status = 0;
                return;
            }   
        ...
        {
            frm_TinhTien paymentDialog = new frm_TinhTien(this.order, this.FoodPrice, this.Discount, this.Extra, this.VAT, this.TotalPrice);
        ...
        private void flowLayoutPanelRight_Paint_2(object sender, PaintEventArgs e)
        {
