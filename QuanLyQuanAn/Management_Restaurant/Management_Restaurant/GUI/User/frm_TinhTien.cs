...
namespace Management_Restaurant.GUI.User
{
    public partial class frm_TinhTien : Form
    {
        ...
        public frm_TinhTien(DAL.Order order, decimal foodPrice, decimal discount, decimal extra, decimal vat, decimal totalPrice)
        {
            InitializeComponent();
            this.order = order;
        ...
        private void btnSave_Click(object sender, EventArgs e)
        {
            ...
            new frm_XuatHoaDon(this.order, this.FoodPrice, this.Discount, this.Extra, this.VAT, this.TotalPrice).ShowDialog();
           
            this.Close();
          
        }

        private void frm_TinhTien_FormClosed(object sender, FormClosedEventArgs e)
        {
          //  this.DialogResult = DialogResult.No;

        }

        private void frm_TinhTien_FormClosing(object sender, FormClosingEventArgs e)
        {
