...
{
    public partial class frm_ChangeTable : Form
    {
        ...
        public frm_ChangeTable()
        {
            InitializeComponent();
        }
        public frm_ChangeTable(DAL.Order order, List<DAL.Table> tables)
        {
            InitializeComponent();
            this.order = order;
            this.Tables = tables;
        ...
        private void frm_ChangeTable_Load(object sender, EventArgs e)
        {
