...
{
    public partial class frm_ThietLapMenu : Form
    {
        public frm_ThietLapMenu()
        {
            InitializeComponent();
        ...
        {
            frm_AddMenu addMenu = new frm_AddMenu();
        ...
        private void btnEditMenu_Click(object sender, EventArgs e)
        {
            ...
            frm_AddMenu addMenu = new frm_AddMenu(menu);
            DialogResult dr = addMenu.ShowDialog();
            if (dr == DialogResult.OK)
            {
                this.LoadData();
        ...
        private void btnAddFood_Click(object sender, EventArgs e)
        {
            ...
            frm_AddMonAn addFood = new frm_AddMonAn(menu);
        ...
        private void menuItemControl_OnEdit(MenuItemControl sender)
        {
            ...
            frm_AddMonAn addFoodDialog = new frm_AddMonAn(menu, sender.MenuItem);
